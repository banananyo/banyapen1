                ...
                <div class="panel-body">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?module=bill&mode=view_bill&id=<?php echo $value['id'] ?>"><?php echo getBillID($conn,$value['orders_ref']); ?></a>
                                </td>
                                <td>
                                <?php 
                                    switch($value['status']) {
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li>
                            <a class="<?php echo 1 == $page ? 'is-hidden':"" ?>" href="index.php?module=bill&mode=confirm&page=<?php echo isset($_GET['page']) ? $_GET['page']-1:2; ?>" aria-label="Previous">
                            ...
                            for($i=1;$i<=ceil($count / $limit);$i++) {
                                ...
                                echo " <li class='".($page == $i ? 'active':'')."'><a href=\"index.php?module=bill&mode=confirm&page=$i$textLimit\">$i</a></li>";
                            } ?>
                           
                            <li>
                            <a class="<?php echo ceil($count / $limit) == $page ? 'is-hidden':"" ?>" href="index.php?module=bill&mode=confirm&page=<?php echo isset($_GET['page']) ? $_GET['page']+1:2; ?>" aria-label="Next">
