...
<head>
    ...
    <title>จัดการสินค้า - ระบบจัดการบ้านยา</title>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class="table table-condensed table-hover">
                       ...
                       $limit = !isset($_GET['limit']) ? 5:$_GET['limit'];
                       $start = ($page*$limit) - $limit;
                       
                       $sql_count = $conn->query("SELECT COUNT(*) FROM `product`");
                       ...
                       if(isset($_GET['filter'])) {
                        ...
                        $sql = "SELECT * FROM `product` WHERE $filter LIMIT $start,$limit";
                    ...
                    ?>
                            <tr>
                                <td class="col-md-1 is-center">
                                     <?php echo $limit * $page - ($limit - 1) + $key; ?>
                                </td>
                                <td class="col-md-2 is-center">
                                    <?php echo "<img class='img-responsive' src='uploads/".$value['image']."' />"; ?>
                                </td>
                                <td class="col-md-3 is-left">
                                    <?php echo $value['name']; ?>
                                </td>
                                <td class="col-md-3 is-left">
                                    <?php echo $value['sdescription']; ?>
                                </td>
                                <td class="col-md-3 is-left">
