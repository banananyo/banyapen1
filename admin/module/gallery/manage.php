                ...
                <div class="panel-body">
                    <table class="table table-condensed table-hover">
                        <tr>
                            ...
                            <td class="col-md-3 is-center">ลำดับ</td>
                       ...
                       $sql_count = $conn->query("SELECT COUNT(*) FROM `gallery`");
                       ...
                       if(isset($_GET['filter'])) {
                        ...
                        $sql = "SELECT * FROM `gallery` WHERE $filter ORDER BY `order` ASC LIMIT $start,$limit";
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?module=gallery&mode=edit&id=<?php echo $value['id'] ?>" class="btn btn-default">แก้ไข</a>
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li>
                            <a class="<?php echo 1 == $page ? 'is-hidden':"" ?>" href="index.php?module=gallery&mode=manage&page=<?php echo isset($_GET['page']) ? $_GET['page']-1:2; ?>" aria-label="Previous">
                            ...
                            for($i=1;$i<=ceil($count / $limit);$i++) {
                                ...
                                echo " <li class='".($page == $i ? 'active':'')."'><a href=\"index.php?module=gallery&mode=manage&page=$i$textLimit\">$i</a></li>";
                            } ?>
                           
                            <li>
                            <a class="<?php echo ceil($count / $limit) == $page ? 'is-hidden':"" ?>" href="index.php?module=gallery&mode=manage&page=<?php echo isset($_GET['page']) ? $_GET['page']+1:2; ?>" aria-label="Next">
