...
<head>
    ...
    <title>ลบหน้าเว็บ - ระบบจัดการบ้านยา</title>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="list-group">
                        <a href="index.php?module=page&mode=manage" class="list-group-item active">
                            จัดการหน้าเว็บ
                        </a>
                        <a href="index.php?module=page&mode=add" class="list-group-item">เพิ่มหน้าเว็บ</a>
                    </div>
                </div>
            </div>
        </div>
		<div class="col-md-8 content">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="is-center">
                        <h4>ลบหน้าเว็บ <?php echo $resultTxt; ?> </h4>
