...
<head>
    ...
    <title>เพิ่มหน้าเว็บ - ระบบจัดการบ้านยา</title>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="list-group">
                        <a href="index.php?module=page&mode=manage" class="list-group-item">
                            จัดการหน้าเว็บ
                        </a>
                        <a href="index.php?module=page&mode=add" class="list-group-item active">เพิ่มหน้าเว็บ</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                ...
                <form action="" method="post"  enctype="multipart/form-data">
                    ...
                    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) { 
                        ...
                        $sql = "INSERT INTO `page` (`id`, `name`, `price`,`description`,`sdescription`, `image`, `stock`, `category_id`) VALUES (NULL, '$name', $price,'$description',`$sdescription`, '$image', $stock, $category_id);";
                    ...
                    <div class="is-center">
                        <h4>เพิ่มหน้าเว็บ <?php echo $resultTxt; ?> </h4>
