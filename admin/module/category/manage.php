                ...
                <div class="panel-body">
                    <table class="table table-condensed table-hover">
                        <tr>
                            ...
                            <td class="col-md-4">ชื่อ</td>
                            <td class="col-md-4">รายละเอียด</td>
                        ...
                        $sql = "SELECT * FROM `category` WHERE $filter LIMIT $start,$limit";
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li>
                            <a class="<?php echo 1 == $page ? 'is-hidden':"" ?>" href="index.php?module=category&mode=manage&page=<?php echo isset($_GET['page']) ? $_GET['page']-1:2; ?>" aria-label="Previous">
                            ...
                            for($i=1;$i<=ceil($count / $limit);$i++) {
                                ...
                                echo " <li class='".($page == $i ? 'active':'')."'><a href=\"index.php?module=category&mode=manage&page=$i$textLimit\">$i</a></li>";
                            } ?>
                           
                            <li>
                            <a class="<?php echo ceil($count / $limit) == $page ? 'is-hidden':"" ?>" href="index.php?module=category&mode=manage&page=<?php echo isset($_GET['page']) ? $_GET['page']+1:2; ?>" aria-label="Next">
